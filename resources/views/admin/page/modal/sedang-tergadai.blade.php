          ...
          <div class="kt-portlet admin-portlet">
            <div class="kt-portlet__head">
              ...
              <div class="kt-portlet__head-toolbar">
                <form action="{{route('sedang.modaltanam.skripsi')}}" method="get">
                            ...
                            <div class="dropdown-menu dropdown-menu-right dropdown-table-custom fade" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
                              <ul class="kt-nav">
                                <li class="kt-nav__item">
                                  <a href="#" class="kt-nav__link detail-data" data-toggle="modal" data-target="#modal-detail-user" data-id="{{$gadais->id}}" data-name="{{$gadais->users->name}}" data-email="{{$gadais->users->email}}" data-nohp="{{$gadais->users->nohp}}" data-keterangan="{{$gadais->keterangan}}" data-kecamatan="{{$gadais->kecamatan}}" data-kelurahan="{{$gadais->kelurahan}}" data-alamat="{{$gadais->alamat}}" data-luas_sawah="{{$gadais->luas_sawah}}" data-admin="{{$admin}}">
                                    <i class="kt-nav__link-icon flaticon2-indent-dots"></i>
                                    <span class="kt-nav__link-text">Detail</span>
                                  </a>
                                </li>
                                <li class="kt-nav__item">
                                  <a href="#" class="kt-nav__link edit-data" data-toggle="modal" data-target="#modal-edit-ket" data-id="{{$gadais->id}}" data-name="{{$gadais->users->name}}" data-keterangan="{{$gadais->keterangan}}" data-href="{{ route('editketerangan.modaltanam', ['id' => $gadais->id]) }}">
