...
<div class="kt-subheader subheader-admin kt-grid__item" id="kt_subheader">
  <div class="kt-container ">
    <div class="kt-subheader__main">
      ...
      <div class="kt-subheader__breadcrumbs">
        <a href="{{ route('index.manage-admin') }}" class="kt-subheader__breadcrumbs-home"><i class="flaticon2-shelter"></i></a>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="dropdown dropdown-inline">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-table-admin fade" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
                            <ul class="kt-nav">
                              <li class="kt-nav__item edit-admin">
                                <a href="#" class="kt-nav__link" data-toggle="modal" data-target="#modal-edit-admin">
