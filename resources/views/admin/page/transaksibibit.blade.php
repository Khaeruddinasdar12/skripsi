        ...
        <div class="col-md-2">
          <div class="kt-portlet kt-iconbox--animate-faster" data-margin-top="100px">
            <div class="kt-portlet__body">
              <h5 style="color: #222;">
                Jumlah Data Transaksi Bibit Yang Tersedia
              </h5>
          ...
          <div class="kt-portlet admin-portlet">
            <div class="kt-portlet__head">
              ...
              <div class="kt-portlet__head-toolbar">
                <form action="{{route('index.tbibit')}}" method="get">
                            ...
                            <div class="dropdown dropdown-inline">
                              ...
                              <div class="dropdown-menu dropdown-menu-right dropdown-table-custom fade" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-149px, 33px, 0px);">
                                <ul class="kt-nav">
                                  ...
                                  @if($transaksi->jenis_bayar == 'cod')
                                  <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link hapus-data" data-toggle="modal" data-target="#modal-pembelian-user" data-id="{{$transaksi->id}}" data-href="{{ route('status.tbibit', ['id' => $transaksi->id]) }}">
                                  ...
                                  <li class="kt-nav__item">
                                    <a href="#" class="kt-nav__link hapus-data" data-toggle="modal" data-target="#modal-hapus" data-id="{{$transaksi->id}}" data-href="{{ route('delete.tbibit', ['id' => $transaksi->id]) }}">
            ...
            <div class="modal-body">
              ...
              <form action="" method="POST" id="hapus-data">
                <div class="form-group">
                  ...
                  <textarea class="form-control" name="keterangan" rows="3" style="margin-top: 0px; margin-bottom: 0px; height: 97px; resize: none" required>Mohon maaf transaksi bibit tidak dapat kami proses.</textarea>
                </div>
                <div class="row verif-form">
                  <div class="col-md-6">
                    <button type="button" class="btn close-modal" data-dismiss="modal" aria-label="Close">Cancel</button>
